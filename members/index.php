...
if (isset($_GET["delete"])) {
    ...
    $idMember = $_GET["id"];
    $message = $_GET["delete"] == "true" ? "Id Anggota $idMember berhasil dihapus!" : "Id Anggota $idMember gagal dihapus!";
};
...
if (isset($_GET["update"])) {
    ...
    $idMember = $_GET["id"];
    $message = $_GET["update"] == "true" ? "Id Anggota $idMember berhasil diupdate!" : "Id Anggota $idMember gagal diupdate!";
};

if (isset($_POST["search"])) {
    $keyword = $_POST["keyword"];
    global $conn;
    $result = mysqli_query($conn, "SELECT * FROM members WHERE name LIKE '%$keyword%' OR email LIKE '%$keyword%'");
    $rows = [];
    while ($row = mysqli_fetch_assoc($result)) {
        $rows[] = $row;
    }
...
<body>
    ...
    <div class="container">
        ...
        <div class="mb-4 row">
            <div class="col">
                <a type="button" class="btn btn-success" href="add.php">Tambah Anggota</a>
            </div>
        </div>
